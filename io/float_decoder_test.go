...
func TestDecodeFloat32(t *testing.T) {
	...
	dec.Error = nil
	dec.Decode(&f)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast []uint8 to float32`)
}
...
func TestDecodeFloat64(t *testing.T) {
	...
	dec.Error = nil
	dec.Decode(&f)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast []uint8 to float64`)
}
