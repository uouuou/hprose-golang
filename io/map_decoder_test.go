...
func TestDecodeMapPtr(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int]int`) // 1
}
...
func TestDecodeIntInt8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int]int8`) // 1
}
...
func TestDecodeIntInt16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int]int16`) // 1
}
...
func TestDecodeIntInt32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int]int32`) // 1
}
...
func TestDecodeIntInt64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int]int64`) // 1
}
...
func TestDecodeIntUintMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int]uint`) // 1
}
...
func TestDecodeIntUint8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int]uint8`) // 1
}
...
func TestDecodeIntUint16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int]uint16`) // 1
}
...
func TestDecodeIntUint32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int]uint32`) // 1
}
...
func TestDecodeIntUint64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int]uint64`) // 1
}
...
func TestDecodeIntFloat32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int]float32`) // 1
}
...
func TestDecodeIntFloat64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int]float64`) // 1
}
...
func TestDecodeIntBoolMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int]bool`) // 1
}
...
func TestDecodeIntStringMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int]string`) // 1
}
...
func TestDecodeIntInterfaceMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int]interface {}`) // 1
}
...
func TestDecodeIntCustomIntMap(t *testing.T) {
	...
	assert.Equal(t, map[int]Int{}, m) // ""
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int]io_test.Int`) // 1
}
...
func TestDecodeInt8IntMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int8]int`) // 1
}
...
func TestDecodeInt8Int8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int8]int8`) // 1
}
...
func TestDecodeInt8Int16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int8]int16`) // 1
}
...
func TestDecodeInt8Int32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int8]int32`) // 1
}
...
func TestDecodeInt8Int64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int8]int64`) // 1
}
...
func TestDecodeInt8UintMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int8]uint`) // 1
}
...
func TestDecodeInt8Uint8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int8]uint8`) // 1
}
...
func TestDecodeInt8Uint16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int8]uint16`) // 1
}
...
func TestDecodeInt8Uint32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int8]uint32`) // 1
}
...
func TestDecodeInt8Uint64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int8]uint64`) // 1
}
...
func TestDecodeInt8Float32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int8]float32`) // 1
}
...
func TestDecodeInt8Float64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int8]float64`) // 1
}
...
func TestDecodeInt8BoolMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int8]bool`) // 1
}
...
func TestDecodeInt8StringMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int8]string`) // 1
}
...
func TestDecodeInt8InterfaceMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int8]interface {}`) // 1
}
...
func TestDecodeInt8CustomIntMap(t *testing.T) {
	...
	assert.Equal(t, map[int8]Int{}, m) // ""
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int8]io_test.Int`) // 1
}
...
func TestDecodeInt16IntMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int16]int`) // 1
}
...
func TestDecodeInt16Int8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int16]int8`) // 1
}
...
func TestDecodeInt16Int16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int16]int16`) // 1
}
...
func TestDecodeInt16Int32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int16]int32`) // 1
}
...
func TestDecodeInt16Int64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int16]int64`) // 1
}
...
func TestDecodeInt16UintMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int16]uint`) // 1
}
...
func TestDecodeInt16Uint8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int16]uint8`) // 1
}
...
func TestDecodeInt16Uint16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int16]uint16`) // 1
}
...
func TestDecodeInt16Uint32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int16]uint32`) // 1
}
...
func TestDecodeInt16Uint64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int16]uint64`) // 1
}
...
func TestDecodeInt16Float32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int16]float32`) // 1
}
...
func TestDecodeInt16Float64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int16]float64`) // 1
}
...
func TestDecodeInt16BoolMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int16]bool`) // 1
}
...
func TestDecodeInt16StringMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int16]string`) // 1
}
...
func TestDecodeInt16InterfaceMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int16]interface {}`) // 1
}
...
func TestDecodeInt16CustomIntMap(t *testing.T) {
	...
	assert.Equal(t, map[int16]Int{}, m) // ""
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int16]io_test.Int`) // 1
}
...
func TestDecodeInt32IntMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int32]int`) // 1
}
...
func TestDecodeInt32Int8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int32]int8`) // 1
}
...
func TestDecodeInt32Int16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int32]int16`) // 1
}
...
func TestDecodeInt32Int32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int32]int32`) // 1
}
...
func TestDecodeInt32Int64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int32]int64`) // 1
}
...
func TestDecodeInt32UintMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int32]uint`) // 1
}
...
func TestDecodeInt32Uint8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int32]uint8`) // 1
}
...
func TestDecodeInt32Uint16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int32]uint16`) // 1
}
...
func TestDecodeInt32Uint32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int32]uint32`) // 1
}
...
func TestDecodeInt32Uint64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int32]uint64`) // 1
}
...
func TestDecodeInt32Float32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int32]float32`) // 1
}
...
func TestDecodeInt32Float64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int32]float64`) // 1
}
...
func TestDecodeInt32BoolMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int32]bool`) // 1
}
...
func TestDecodeInt32StringMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int32]string`) // 1
}
...
func TestDecodeInt32InterfaceMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int32]interface {}`) // 1
}
...
func TestDecodeInt32CustomIntMap(t *testing.T) {
	...
	assert.Equal(t, map[int32]Int{}, m) // ""
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int32]io_test.Int`) // 1
}
...
func TestDecodeInt64IntMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int64]int`) // 1
}
...
func TestDecodeInt64Int8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int64]int8`) // 1
}
...
func TestDecodeInt64Int16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int64]int16`) // 1
}
...
func TestDecodeInt64Int32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int64]int32`) // 1
}
...
func TestDecodeInt64Int64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int64]int64`) // 1
}
...
func TestDecodeInt64UintMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int64]uint`) // 1
}
...
func TestDecodeInt64Uint8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int64]uint8`) // 1
}
...
func TestDecodeInt64Uint16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int64]uint16`) // 1
}
...
func TestDecodeInt64Uint32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int64]uint32`) // 1
}
...
func TestDecodeInt64Uint64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int64]uint64`) // 1
}
...
func TestDecodeInt64Float32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int64]float32`) // 1
}
...
func TestDecodeInt64Float64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int64]float64`) // 1
}
...
func TestDecodeInt64BoolMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int64]bool`) // 1
}
...
func TestDecodeInt64StringMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int64]string`) // 1
}
...
func TestDecodeInt64InterfaceMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int64]interface {}`) // 1
}
...
func TestDecodeInt64CustomIntMap(t *testing.T) {
	...
	assert.Equal(t, map[int64]Int{}, m) // ""
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[int64]io_test.Int`) // 1
}
...
func TestDecodeUintIntMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint]int`) // 1
}
...
func TestDecodeUintInt8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint]int8`) // 1
}
...
func TestDecodeUintInt16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint]int16`) // 1
}
...
func TestDecodeUintInt32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint]int32`) // 1
}
...
func TestDecodeUintInt64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint]int64`) // 1
}
...
func TestDecodeUintUintMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint]uint`) // 1
}
...
func TestDecodeUintUint8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint]uint8`) // 1
}
...
func TestDecodeUintUint16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint]uint16`) // 1
}
...
func TestDecodeUintUint32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint]uint32`) // 1
}
...
func TestDecodeUintUint64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint]uint64`) // 1
}
...
func TestDecodeUintFloat32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint]float32`) // 1
}
...
func TestDecodeUintFloat64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint]float64`) // 1
}
...
func TestDecodeUintBoolMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint]bool`) // 1
}
...
func TestDecodeUintStringMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint]string`) // 1
}
...
func TestDecodeUintInterfaceMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint]interface {}`) // 1
}
...
func TestDecodeUintCustomIntMap(t *testing.T) {
	...
	assert.Equal(t, map[uint]Int{}, m) // ""
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint]io_test.Int`) // 1
}
...
func TestDecodeUint8IntMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint8]int`) // 1
}
...
func TestDecodeUint8Int8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint8]int8`) // 1
}
...
func TestDecodeUint8Int16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint8]int16`) // 1
}
...
func TestDecodeUint8Int32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint8]int32`) // 1
}
...
func TestDecodeUint8Int64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint8]int64`) // 1
}
...
func TestDecodeUint8UintMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint8]uint`) // 1
}
...
func TestDecodeUint8Uint8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint8]uint8`) // 1
}
...
func TestDecodeUint8Uint16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint8]uint16`) // 1
}
...
func TestDecodeUint8Uint32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint8]uint32`) // 1
}
...
func TestDecodeUint8Uint64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint8]uint64`) // 1
}
...
func TestDecodeUint8Float32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint8]float32`) // 1
}
...
func TestDecodeUint8Float64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint8]float64`) // 1
}
...
func TestDecodeUint8BoolMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint8]bool`) // 1
}
...
func TestDecodeUint8StringMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint8]string`) // 1
}
...
func TestDecodeUint8InterfaceMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint8]interface {}`) // 1
}
...
func TestDecodeUint8CustomIntMap(t *testing.T) {
	...
	assert.Equal(t, map[uint8]Int{}, m) // ""
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint8]io_test.Int`) // 1
}
...
func TestDecodeUint16IntMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint16]int`) // 1
}
...
func TestDecodeUint16Int8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint16]int8`) // 1
}
...
func TestDecodeUint16Int16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint16]int16`) // 1
}
...
func TestDecodeUint16Int32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint16]int32`) // 1
}
...
func TestDecodeUint16Int64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint16]int64`) // 1
}
...
func TestDecodeUint16UintMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint16]uint`) // 1
}
...
func TestDecodeUint16Uint8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint16]uint8`) // 1
}
...
func TestDecodeUint16Uint16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint16]uint16`) // 1
}
...
func TestDecodeUint16Uint32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint16]uint32`) // 1
}
...
func TestDecodeUint16Uint64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint16]uint64`) // 1
}
...
func TestDecodeUint16Float32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint16]float32`) // 1
}
...
func TestDecodeUint16Float64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint16]float64`) // 1
}
...
func TestDecodeUint16BoolMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint16]bool`) // 1
}
...
func TestDecodeUint16StringMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint16]string`) // 1
}
...
func TestDecodeUint16InterfaceMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint16]interface {}`) // 1
}
...
func TestDecodeUint16CustomIntMap(t *testing.T) {
	...
	assert.Equal(t, map[uint16]Int{}, m) // ""
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint16]io_test.Int`) // 1
}
...
func TestDecodeUint32IntMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint32]int`) // 1
}
...
func TestDecodeUint32Int8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint32]int8`) // 1
}
...
func TestDecodeUint32Int16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint32]int16`) // 1
}
...
func TestDecodeUint32Int32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint32]int32`) // 1
}
...
func TestDecodeUint32Int64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint32]int64`) // 1
}
...
func TestDecodeUint32UintMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint32]uint`) // 1
}
...
func TestDecodeUint32Uint8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint32]uint8`) // 1
}
...
func TestDecodeUint32Uint16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint32]uint16`) // 1
}
...
func TestDecodeUint32Uint32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint32]uint32`) // 1
}
...
func TestDecodeUint32Uint64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint32]uint64`) // 1
}
...
func TestDecodeUint32Float32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint32]float32`) // 1
}
...
func TestDecodeUint32Float64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint32]float64`) // 1
}
...
func TestDecodeUint32BoolMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint32]bool`) // 1
}
...
func TestDecodeUint32StringMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint32]string`) // 1
}
...
func TestDecodeUint32InterfaceMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint32]interface {}`) // 1
}
...
func TestDecodeUint32CustomIntMap(t *testing.T) {
	...
	assert.Equal(t, map[uint32]Int{}, m) // ""
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint32]io_test.Int`) // 1
}
...
func TestDecodeUint64IntMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint64]int`) // 1
}
...
func TestDecodeUint64Int8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint64]int8`) // 1
}
...
func TestDecodeUint64Int16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint64]int16`) // 1
}
...
func TestDecodeUint64Int32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint64]int32`) // 1
}
...
func TestDecodeUint64Int64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint64]int64`) // 1
}
...
func TestDecodeUint64UintMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint64]uint`) // 1
}
...
func TestDecodeUint64Uint8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint64]uint8`) // 1
}
...
func TestDecodeUint64Uint16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint64]uint16`) // 1
}
...
func TestDecodeUint64Uint32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint64]uint32`) // 1
}
...
func TestDecodeUint64Uint64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint64]uint64`) // 1
}
...
func TestDecodeUint64Float32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint64]float32`) // 1
}
...
func TestDecodeUint64Float64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint64]float64`) // 1
}
...
func TestDecodeUint64BoolMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint64]bool`) // 1
}
...
func TestDecodeUint64StringMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint64]string`) // 1
}
...
func TestDecodeUint64InterfaceMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint64]interface {}`) // 1
}
...
func TestDecodeUint64CustomIntMap(t *testing.T) {
	...
	assert.Equal(t, map[uint64]Int{}, m) // ""
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uint64]io_test.Int`) // 1
}
...
func TestDecodeFloat32IntMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float32]int`) // 1
}
...
func TestDecodeFloat32Int8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float32]int8`) // 1
}
...
func TestDecodeFloat32Int16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float32]int16`) // 1
}
...
func TestDecodeFloat32Int32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float32]int32`) // 1
}
...
func TestDecodeFloat32Int64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float32]int64`) // 1
}
...
func TestDecodeFloat32UintMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float32]uint`) // 1
}
...
func TestDecodeFloat32Uint8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float32]uint8`) // 1
}
...
func TestDecodeFloat32Uint16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float32]uint16`) // 1
}
...
func TestDecodeFloat32Uint32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float32]uint32`) // 1
}
...
func TestDecodeFloat32Uint64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float32]uint64`) // 1
}
...
func TestDecodeFloat32Float32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float32]float32`) // 1
}
...
func TestDecodeFloat32Float64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float32]float64`) // 1
}
...
func TestDecodeFloat32BoolMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float32]bool`) // 1
}
...
func TestDecodeFloat32StringMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float32]string`) // 1
}
...
func TestDecodeFloat32InterfaceMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float32]interface {}`) // 1
}
...
func TestDecodeFloat32CustomIntMap(t *testing.T) {
	...
	assert.Equal(t, map[float32]Int{}, m) // ""
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float32]io_test.Int`) // 1
}
...
func TestDecodeFloat64IntMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float64]int`) // 1
}
...
func TestDecodeFloat64Int8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float64]int8`) // 1
}
...
func TestDecodeFloat64Int16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float64]int16`) // 1
}
...
func TestDecodeFloat64Int32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float64]int32`) // 1
}
...
func TestDecodeFloat64Int64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float64]int64`) // 1
}
...
func TestDecodeFloat64UintMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float64]uint`) // 1
}
...
func TestDecodeFloat64Uint8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float64]uint8`) // 1
}
...
func TestDecodeFloat64Uint16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float64]uint16`) // 1
}
...
func TestDecodeFloat64Uint32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float64]uint32`) // 1
}
...
func TestDecodeFloat64Uint64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float64]uint64`) // 1
}
...
func TestDecodeFloat64Float32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float64]float32`) // 1
}
...
func TestDecodeFloat64Float64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float64]float64`) // 1
}
...
func TestDecodeFloat64BoolMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float64]bool`) // 1
}
...
func TestDecodeFloat64StringMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float64]string`) // 1
}
...
func TestDecodeFloat64InterfaceMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float64]interface {}`) // 1
}
...
func TestDecodeFloat64CustomIntMap(t *testing.T) {
	...
	assert.Equal(t, map[float64]Int{}, m) // ""
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[float64]io_test.Int`) // 1
}
...
func TestDecodeStringIntMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[string]int`) // 1
}
...
func TestDecodeStringInt8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[string]int8`) // 1
}
...
func TestDecodeStringInt16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[string]int16`) // 1
}
...
func TestDecodeStringInt32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[string]int32`) // 1
}
...
func TestDecodeStringInt64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[string]int64`) // 1
}
...
func TestDecodeStringUintMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[string]uint`) // 1
}
...
func TestDecodeStringUint8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[string]uint8`) // 1
}
...
func TestDecodeStringUint16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[string]uint16`) // 1
}
...
func TestDecodeStringUint32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[string]uint32`) // 1
}
...
func TestDecodeStringUint64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[string]uint64`) // 1
}
...
func TestDecodeStringFloat32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[string]float32`) // 1
}
...
func TestDecodeStringFloat64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[string]float64`) // 1
}
...
func TestDecodeStringBoolMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[string]bool`) // 1
}
...
func TestDecodeStringStringMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[string]string`) // 1
}
...
func TestDecodeStringInterfaceMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[string]interface {}`) // 1
}
...
func TestDecodeStringCustomIntMap(t *testing.T) {
	...
	assert.Equal(t, map[string]Int{}, m) // ""
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[string]io_test.Int`) // 1
}
...
func TestDecodeInterfaceIntMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[interface {}]int`) // 1
}
...
func TestDecodeInterfaceInt8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[interface {}]int8`) // 1
}
...
func TestDecodeInterfaceInt16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[interface {}]int16`) // 1
}
...
func TestDecodeInterfaceInt32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[interface {}]int32`) // 1
}
...
func TestDecodeInterfaceInt64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[interface {}]int64`) // 1
}
...
func TestDecodeInterfaceUintMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[interface {}]uint`) // 1
}
...
func TestDecodeInterfaceUint8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[interface {}]uint8`) // 1
}
...
func TestDecodeInterfaceUint16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[interface {}]uint16`) // 1
}
...
func TestDecodeInterfaceUint32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[interface {}]uint32`) // 1
}
...
func TestDecodeInterfaceUint64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[interface {}]uint64`) // 1
}
...
func TestDecodeInterfaceFloat32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[interface {}]float32`) // 1
}
...
func TestDecodeInterfaceFloat64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[interface {}]float64`) // 1
}
...
func TestDecodeInterfaceBoolMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[interface {}]bool`) // 1
}
...
func TestDecodeInterfaceStringMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[interface {}]string`) // 1
}
...
func TestDecodeInterfaceInterfaceMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[interface {}]interface {}`) // 1
}
...
func TestDecodeInterfaceCustomIntMap(t *testing.T) {
	...
	assert.Equal(t, map[interface{}]Int{}, m) // ""
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[interface {}]io_test.Int`) // 1
}
...
func TestDecodeUintptrIntMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uintptr]int`) // 1
}
...
func TestDecodeUintptrInt8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uintptr]int8`) // 1
}
...
func TestDecodeUintptrInt16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uintptr]int16`) // 1
}
...
func TestDecodeUintptrInt32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uintptr]int32`) // 1
}
...
func TestDecodeUintptrInt64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uintptr]int64`) // 1
}
...
func TestDecodeUintptrUintMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uintptr]uint`) // 1
}
...
func TestDecodeUintptrUint8Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uintptr]uint8`) // 1
}
...
func TestDecodeUintptrUint16Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uintptr]uint16`) // 1
}
...
func TestDecodeUintptrUint32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uintptr]uint32`) // 1
}
...
func TestDecodeUintptrUint64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uintptr]uint64`) // 1
}
...
func TestDecodeUintptrFloat32Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uintptr]float32`) // 1
}
...
func TestDecodeUintptrFloat64Map(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uintptr]float64`) // 1
}
...
func TestDecodeUintptrBoolMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uintptr]bool`) // 1
}
...
func TestDecodeUintptrStringMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uintptr]string`) // 1
}
...
func TestDecodeUintptrInterfaceMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uintptr]interface {}`) // 1
}
...
func TestDecodeUintptrCustomIntMap(t *testing.T) {
	...
	assert.Equal(t, map[uintptr]Int{}, m) // ""
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[uintptr]io_test.Int`) // 1
}
...
func TestDecodeComplex64CustomIntMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[complex64]io_test.Int`) // 1
}
...
func TestDecodeComplex128CustomIntMap(t *testing.T) {
	...
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[complex128]io_test.Int`) // 1
}
...
func TestDecodeCustomIntCustomIntMap(t *testing.T) {
	...
	assert.Equal(t, map[Int]Int{}, m) // ""
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast int to map[io_test.Int]io_test.Int`) // 1
}
...
func TestDecodeMapError(t *testing.T) {
	...
	var m map[*int]int
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast []interface {} to map[*int]int`)
	dec.Error = nil
	var slice []int
	dec.Decode(&slice)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast map[interface {}]interface {} to []int`)
}
...
func TestHproseDecodeObjectAsMapError(t *testing.T) {
	...
	var m map[string]string
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast map[string]interface {} to map[string]string`)
}
...
func TestHproseDecodeObjectAsMapError2(t *testing.T) {
	...
	var m map[string]string
	dec.Decode(&m)
	assert.EqualError(t, dec.Error, `hprose/io: can not cast *io_test.TestStruct4 to map[string]string`)
}
