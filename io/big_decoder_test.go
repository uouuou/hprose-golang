...
func TestDecodeBigInt(t *testing.T) {
	...
	assert.Equal(t, big.NewInt(0), &i)
	dec.Decode(&i)
	assert.EqualError(t, dec.Error, "hprose/io: can not parse NaN to big.Int")
	dec.Error = nil
	dec.Decode(&i)
	assert.EqualError(t, dec.Error, "hprose/io: can not parse +Inf to big.Int")
	dec.Error = nil
	dec.Decode(&i)
	assert.EqualError(t, dec.Error, "hprose/io: can not parse -Inf to big.Int")
	dec.Error = nil
...
func TestDecodeBigFloat(t *testing.T) {
	...
	assert.Equal(t, big.NewFloat(0), &i)
	dec.Decode(&i)
	assert.EqualError(t, dec.Error, "hprose/io: can not parse NaN to big.Float")
	dec.Error = nil
	dec.Decode(&i)
...
func TestDecodeBigRat(t *testing.T) {
	...
	assert.Equal(t, big.NewRat(0, 1), &i)
	dec.Decode(&i)
	assert.EqualError(t, dec.Error, "hprose/io: can not parse NaN to big.Rat")
	dec.Error = nil
	dec.Decode(&i)
	assert.EqualError(t, dec.Error, "hprose/io: can not parse +Inf to big.Rat")
	dec.Error = nil
	dec.Decode(&i)
	assert.EqualError(t, dec.Error, "hprose/io: can not parse -Inf to big.Rat")
	dec.Error = nil
